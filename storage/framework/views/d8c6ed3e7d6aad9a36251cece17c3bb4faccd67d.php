 <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html"> <img alt="image" src="<?php echo e(asset('assets/img/logo.png')); ?>" class="header-logo" /> <span
                class="logo-name">Eco Paints </span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <!-- <li class="menu-header">Main</li> -->
            <li class="dropdown active">
              <a href="<?php echo e(URL::to('/')); ?>/" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
            </li>
            
             <li class="dropdown ">
              <a href="<?php echo e(URL::to('/')); ?>/logo/logo" class="nav-link"><i data-feather="briefcase"></i><span>Logo</span></a>
            </li>
           ...
           <!--  <li class="dropdown">
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="copy"></i><span>Home Page</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?php echo e(URL::to('/')); ?>/slider/slider">Slider</a></li>
                <li><a class="nav-link" href="<?php echo e(URL::to('/')); ?>/choose_us/chooseus">Why Choose Us</a></li>
                <li><a class="nav-link" href="<?php echo e(URL::to('/')); ?>/about_home/aboutus">About us</a></li>
                <li><a class="nav-link" href="<?php echo e(URL::to('/')); ?>/feedback/feedback">Feedbacks</a></li>
                <li><a class="nav-link" href="<?php echo e(URL::to('/')); ?>/social_media/socialmedia/">Footer</a></li>
               
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="shopping-bag"></i><span>About us Page</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?php echo e(URL::to('/')); ?>/profile/profile">Profile</a></li>
                <li><a class="nav-link" href="<?php echo e(URL::to('/')); ?>/manufacturing/manufacturing">Manufacturing</a></li>
                <li><a class="nav-link" href="<?php echo e(URL::to('/')); ?>/technology/technology">Technology</a></li>
                <li><a class="nav-link" href="<?php echo e(URL::to('/')); ?>/vision_mision/vision">Vision & Mission</a></li>
                <li><a class="nav-link" href="<?php echo e(URL::to('/')); ?>/quality_policy/quality">Quality Policy & Infrastructure</a></li>
                
              </ul>
            </li>

            <li><a class="nav-link" href="<?php echo e(URL::to('/')); ?>/category/category"><i data-feather="file"></i><span>Category master</span></a></li>

                        <li><a class="nav-link" href="<?php echo e(URL::to('/')); ?>/product/product"><i data-feather="image"></i><span> Product Master</span></a></li>

                        <li><a class="nav-link" href="<?php echo e(URL::to('/')); ?>/catalogue/catalogue"><i data-feather="file"></i><span> Catalogue</span></a></li>

                        <li><a class="nav-link" href="<?php echo e(URL::to('/')); ?>/contactus/contactus"><i data-feather="user"></i><span>Contact</span></a></li>
