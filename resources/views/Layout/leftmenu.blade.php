        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              <a href="{{URL::to('/')}}/" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
            </li>
            
             <li class="dropdown ">
              <a href="{{URL::to('/')}}/logo/logo" class="nav-link"><i data-feather="briefcase"></i><span>Logo</span></a>
            </li>
           ...
           <!--  <li class="dropdown">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{URL::to('/')}}/slider/slider">Slider</a></li>
                <li><a class="nav-link" href="{{URL::to('/')}}/choose_us/chooseus">Why Choose Us</a></li>
                <li><a class="nav-link" href="{{URL::to('/')}}/about_home/aboutus">About us</a></li>
                <li><a class="nav-link" href="{{URL::to('/')}}/feedback/feedback">Feedbacks</a></li>
                <li><a class="nav-link" href="{{URL::to('/')}}/social_media/socialmedia/">Footer</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{URL::to('/')}}/profile/profile">Profile</a></li>
                <li><a class="nav-link" href="{{URL::to('/')}}/manufacturing/manufacturing">Manufacturing</a></li>
                <li><a class="nav-link" href="{{URL::to('/')}}/technology/technology">Technology</a></li>
                <li><a class="nav-link" href="{{URL::to('/')}}/vision_mision/vision">Vision & Mission</a></li>
                <li><a class="nav-link" href="{{URL::to('/')}}/quality_policy/quality">Quality Policy & Infrastructure</a></li>
                
              </ul>
            </li>

            <li><a class="nav-link" href="{{URL::to('/')}}/category/category"><i data-feather="file"></i><span>Category master</span></a></li>

                        <li><a class="nav-link" href="{{URL::to('/')}}/product/product"><i data-feather="image"></i><span> Product Master</span></a></li>

                        <li><a class="nav-link" href="{{URL::to('/')}}/catalogue/catalogue"><i data-feather="file"></i><span> Catalogue</span></a></li>

                        <li><a class="nav-link" href="{{URL::to('/')}}/contactus/contactus"><i data-feather="user"></i><span>Contact</span></a></li>
