...
@endif 
  ...
  @foreach($category as $list)
                    <form action="{{URL::to('/')}}/category/masterUpdate/{{ $list->id }}" method="post"   enctype="multipart/form-data">
                     {{ csrf_field() }}      
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        ...
                        <input type="file" class="form-control" name="photo" src="{{ URL::to('/') }}/picture/category/{{ $list->photo }}" style="width: 400px; height: 45px;">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputPassword3" class="col-sm-3 col-form-label">Image</label>
                      <div class="col-sm-9">
                        <input type="image" class="form-control" name="photo" src="{{ URL::to('/') }}/picture/category/{{ $list->photo }}" style="width: 400px; height: 150px;">
                      </div>
                    </div>
